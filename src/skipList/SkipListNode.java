...
public class SkipListNode<T> {
	 ...
	 * 
	 * @param key
	 *            The key for access of the node being created.
	 * @param value
	 *            The value to be stored at the node.
	 * @param height
	 ...
	 * 
	 * @param level
	 *            The level where the link must be created.
	 * @param forward
	 *            the node that will be linked to the one executing this method.
	 * 
	 */
