package doublyLinkedList.iterative;
...
public class DoublyLinkedListNode<T> extends SinglyLinkedListNode<T> {
	 ...
	 * @param next The next node of the DoublyLinkedList containing this node.
	 * @param next The previous node of the DoublyLinkedList containing this node.
	 * 
	 */
