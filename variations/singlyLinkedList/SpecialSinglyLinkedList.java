package variations.singlyLinkedList;

import singlyLinkedList.iterative.SinglyLinkedList;
...
public class SpecialSinglyLinkedList<T> extends SinglyLinkedList<T> {
	 ...
	 * 
	 * @param element1 The first element to be validated.
	 * @param element2 The second element to be validated.
	 * 
	 ...
	 * 
	 * @param backwardIndex the index of the target element starting from the end of
	 *                      the list.
	 *
